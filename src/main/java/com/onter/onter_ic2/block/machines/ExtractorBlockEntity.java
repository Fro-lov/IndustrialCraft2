...
public class ExtractorBlockEntity extends BaseMachineBlockEntity {
    public ExtractorBlockEntity(BlockPos pos, BlockState blockState) {
        this(ModBlockEntities.EXTRACTOR.get(), pos, blockState, 40000, 8, 300, 1); // 8 FE/t (2 EU/t), 300 ticks
    }

    public ExtractorBlockEntity(net.minecraft.world.level.block.entity.BlockEntityType<?> type, BlockPos pos, BlockState blockState,
    ...
    public boolean isValidInput(ItemStack stack) {
        ...
        return level.getRecipeManager().getRecipeFor(ModRecipeTypes.EXTRACTOR_RECIPE_TYPE.get(), new SingleRecipeInput(stack), level).isPresent();
    }
